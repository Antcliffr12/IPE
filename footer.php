<section id="ipe-primary-footer">
  <div class="rvt-container rvt-container--senior rvt-container--center">
    <div class="rvt-grid">
          <div class="rvt-grid__item-lg">
          <div class="ipe-primary-container">
                    <h4>WEBMASTER ASSISTANCE</h4>
                    <div class="ipe-primary-section">
                      <img class="peds-logo" src="<?= THEME_PATH; ?>/assets/images/Logo-IU-IPE.png" alt="IPE"/>
                      <p>Call webmaster at 317-274-7337</p>
                    </div>
                  </div>
            ...
            <div class="ipe-primary-container">
              ...
              <div class="ipe-primary-section">
                <div class="useful-links">
                  <a href="#">Register to Access IU Shared Resources</a>
                  <a href="#">Register for Events (Students & Faculty)</a>
                  <a href="https://archive.president.iu.edu/initiatives/clinical-affairs/index.shtml" target="_blank">Clinical Affairs Schools/Partner Programs</a>
                </div>
              </div>
             </div>
          </div>
              ...
              <h4>STAY CONNECTED</h4>
                <div class="ipe-primary-section">
                  <div class="social-media-platforms">
                    ...
                    <img src="<?= THEME_PATH ?>/assets/images/Icon-Facebook.png" alt="Facebook"/>
                      <p>Facebook</p>
                    </a>
                    <a href="#" class="social-platform">
                    <img src="<?= THEME_PATH ?>/assets/images/Icon-Twitter.png" alt="Twitter"/>
                        <p>Twitter</p>
                      </a>
                      <a href="#" class="social-platform">
                      <img src="<?= THEME_PATH ?>/assets/images/Icon-Instagram.png" alt="Instagram"/>
                          <p>Instagram</p>
                        </a>
                  </div>
                </div>
...
<div id="footer-v1" role="contentinfo" itemscope="itemscope" itemtype="http://schema.org/CollegeOrUniversity">
	<div class="wrapper">
    ...
    <span class="visually-hidden">Celebrating 200 years</span>
        ...
        <p class="copyright">
            <a href="https://www.iu.edu/" class="block-iu"><img src="//assets.iu.edu/brand/legacy/block-iu.png" height="26" width="22" alt="Block IU" /></a>
            <span class="line-break"><a href="https://www.iu.edu/copyright/index.html">Copyright</a> &#169; 2019</span>
            <span class="line-break">The Trustees of <a href="https://www.iu.edu/" itemprop="url"><span itemprop="name">Indiana University</span></a>,</span>
            <span class="line-break"><a href="https://www.iu.edu/copyright/index.html#complaints">Copyright Complaints</a></span>
        </p>
