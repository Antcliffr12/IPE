(function(window, document, undefined) {
    ...
    var n,
      ...
      c = function(n, t) {
        "[object Array]" !== Object.prototype.toString.call(n) &&
          (n = n.split(" "));
        for (var s = 0; s < n.length; s++) t(n[s], s);
      };
    return (
      "classList" in document.documentElement
        ...
        : ((n = function(n, t) {
          ...
          (t = function(t, s) {
            n(t, s) || (t.className += (t.className ? " " : "") + s);
          }),
          (s = function(t, s) {
            n(t, s) &&
      ...
      (o.hasClass = function(t, s) {
        return n(t, s);
      }),
      (o.addClass = function(n, s) {
        c(s, function(s) {
          t(n, s);
        });
      }),
      (o.removeClass = function(n, t) {
        c(t, function(t) {
          s(n, t);
        });
      }),
  ...
  IUSearch.prototype.renderSearchElements = function() {
    ...
    if (search !== null) {
      ...
      search
        .appendChild(wrapper)
        .setAttribute("class", scope.settings.wrapClass);
